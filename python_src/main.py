...
if __name__ == '__main__':
    ...
    if(graph_type=='twitter'):
        ...
        node_ids_inRange, outdegrees = get_node_ids_inRange("../data/twitter_id_degree.txt", 30, 45)
        advertiser_list, advertiser_outdegrees = choose_random_advertisers(node_ids_inRange, outdegrees, 100)
