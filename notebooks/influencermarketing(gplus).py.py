...
Original file is located at
    https://colab.research.google.com/drive/1q6NKPAVt02WGKkkPMdf90Zi3beCcha_R
"""

# from google.colab import drive
# drive.mount('/content/drive')
# !cp "/content/drive/My Drive/AI project/datasets/cleaned_gplus_combined.txt" "cleaned_gplus_combined.txt"
# !cp "/content/drive/My Drive/AI project/datasets/gplus_id_degree.txt" "gplus_id_degree.txt"
...
# Utils.clean_dataset('twitter_combined.txt','cleaned_twitter_combined.txt')
# Utils.id_degree_file_genrator('cleaned_twitter_combined.txt','twitter_id_degree.txt')
...
# graph.create_twitter_graph(filepath='cleaned_twitter_combined.txt')
# graph.create_networkx_graph(n=30000,k=1000,p=0.9)
...
# f = open('networkx_id_degree.txt','w')
# for k,v in graph.graph.items():
#     f.write("{},{}\n".format(k,len(v)))
# for i in graph.nodes:
#     if(i not in graph.graph.keys()):
...
f = open('../experimental_results/interest_0.5_0.2/gplus_p90.csv','a')
...
def run_experiment():
  for i in range(1, 7):
    ...
    model = InfluencerAdvertisingModel(width,height,graph,node_ids,90,200,grid)
...
pool.map(run_experiments, range(0, 4))
